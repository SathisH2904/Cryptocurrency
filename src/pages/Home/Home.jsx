  ...
  return (
    <div className='home'>
        <div className='hero'>
            ...
            <p>Welcome to the world's largest cryptocurrence
                marketplace. Sign up to explore more about cryptos.</p>
            <form onSubmit={searchHandler}>
                <input list="coinlist" type="text" placeholder='search crypto..' onChange={inputHandler} required value={input}></input>
